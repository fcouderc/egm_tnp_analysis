...
ICHEP2016 = {
    ...
    'data_2016_runD_ele' :  tnpSample('data_2016_runD_ele', eosDir + 'Photons_76Xids/elev2/data/TnPTree_SingleElectron_2016_RunD.root' , lumi = 0.635 ),
    ...
    'data_2016_runD_pho' :  tnpSample('data_2016_runD_pho', eosDir + 'Photons_76Xids/phov2/data/TnPTree_SingleElectron_2016_RunD.root' , lumi = 0.641 ),
